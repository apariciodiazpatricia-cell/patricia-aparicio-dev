...
[![Tailwind CSS](https://img.shields.io/badge/TAILWIND_CSS-3.4-38B2AC?style=for-the-badge&logo=tailwind-css&logoColor=white&labelColor=0a0a0a)](https://tailwindcss.com/)
[![Google Gemini](https://img.shields.io/badge/GOOGLE_GEMINI-2.5_FLASH-8E75B2?style=for-the-badge&logo=google&logoColor=white&labelColor=0a0a0a)](https://ai.google.dev/)
[![Node.js](https://img.shields.io/badge/NODE.JS-20.x-339933?style=for-the-badge&logo=node.js&logoColor=white&labelColor=0a0a0a)](https://nodejs.org/)
[![Vite](https://img.shields.io/badge/VITE-8.3_TURBO-646CFF?style=for-the-badge&logo=vite&logoColor=white&labelColor=0a0a0a)](https://vitejs.dev/)
[![Figma](https://img.shields.io/badge/FIGMA-UI%2FUX_SYSTEMS-F24E1E?style=for-the-badge&logo=figma&logoColor=white&labelColor=0a0a0a)](https://figma.com/)
...
* 🕹️ **Navbar Pac-Man Fijo (`NavbarPacman.jsx`):** Diseñé una barra superior fija (`fixed top-0 z-50`) con una pista donde Pac-Man va recorriendo la pantalla y comiendo bolitas de energía sincronizado con el scroll y la navegación.
...
<table align="center" style="border: 2px solid #00FF66; border-radius: 16px; background-color: #0d0d0d;">
  <tr>
    <td align="center" style="padding: 24px;">
      <img src="https://github.com/apariciodiazpatricia-cell.png" width="140px" style="border-radius: 50%; border: 3px solid #00FF66; box-shadow: 0 0 25px rgba(0,255,102,0.4);" alt="Patri Aparicio Avatar" /><br><br>
